...
public class Ex02Student {
    public static void main(String[] args) {
        ...
        System.out.println("s.name(참조형초기화값): " + s.getName());
        System.out.println("s.id(기본형초기화값): " + s.getId());
        ...
        //System.out.println()에 객체를 집어넣으면 해당 객체의 toString()이라는 메소드를 실행시켜서 그 결과값을 출력한다.
