...
public class BoardController {
    ...
    public ArrayList<BoardDTO> selectAll() {
        ...
        // deep copy: 객체의 필드값을 복사하여 새로운 객체의 필드에 저장
        ...
        for (BoardDTO b : list) {
            ...
            tempCalendar2.setTime(b.getWrittenDate().getTime());
    ...
    // 3. 파라미터로 넘어온 BoardDTO 객체를 list에 추가하는 insert() 메소드
